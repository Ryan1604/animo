    ...
    <section class="section">
        ...
        <div class="section-body">
            <?php foreach ($result as $data) : ?>
                <form method="post" class="needs-validation" action="<?php echo site_url('admin/peserta/update') ?>" novalidate="">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="kodim_kabupaten_kota">Kodim/Kabupaten/Kota <sup class="text-danger">*</sup></label>
                                        <input id="kodim_kabupaten_kota" type="text" class="form-control" name="kodim_kabupaten_kota" tabindex="1" value="<?= $data->kodim_kabupaten_kota ?>">
                                        <div class="invalid-feedback">
                                            Masukkan Kodim/Kabupaten/Kota terlebih dahulu
                                        </div>
                                    </div>
                                </div>
                            </div>
